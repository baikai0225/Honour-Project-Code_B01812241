...
> BSc (Hons) Cyber Security — University of Birmingham  
> Student ID: B01812241
...
analyzer = CapeAnalyzer(api_url="http://172.28.169.166:8000")
...
# CAPEv2 settings
CAPE_API_URL = "http://172.28.169.166:8000"
...
This project was developed as part of a BSc (Hons) Cyber Security dissertation at the University of Birmingham. For academic use only.
